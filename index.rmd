...
1. The <a rhef="linea_getting_started.html">Getting Started</a> page is a good place to start learning how to build linear models with `linea`.

2. The <a rhef="linea_advanced_features.html">Advanced Features</a> page shows how to implement the features of `linea` that allow users to capture <b>non-linear relationships</b>.

3. The <a rhef="linea_additional_features.html">Additional Features</a> page all other functions of the library.

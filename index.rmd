...
* You can consult <span class='logo_span'>LINEA</span>'s [NEWS.md](https://github.com/paladinic/linea/blob/master/NEWS.md) page on Github for details on the improvements from the last version.
